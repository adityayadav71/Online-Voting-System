          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="name">
                  Voter ID</label>
                <input type="text" class="form-control" name="vid" id="VID" placeholder="Enter your VID"
                  required="required" />
              </div>
              <div class="form-group">
                <label for="subject">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="name">
                  Message</label>
                <textarea name="message" id="message" name="msg" class="form-control" rows="9" cols="25"
