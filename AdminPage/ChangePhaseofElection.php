    ...
    <div class="content">
      <form action="" method="POST">
          ...
          <div class="input-box">
            <?php
                while($rows= $sql->fetch_assoc())
                      {
            ?>
            <h1 id="demo" style="font-family: 'Lato';font-size: 50px;text-align: center;"><?php echo $rows['Phase']?>
            </h1>
            <?php
                      }
            ?>
        ...
        <div class="button" style="display: inline;margin: 35px 50px;">
          <input type="submit" name="reg" value="Registration Phase"
            style="width: 24%;height: 100px; padding: 10px; font-size: x-large;">
        </div>
        <div class="button" style="display: inline;margin: 35px 50px;">
          <input type="submit" name="voting" value="Voting Phase"
            style="width: 24%;margin: 10px -26px;height: 100px; padding: 10px; font-size: x-large;">
        </div>
        <div class="button" style="display: inline;margin: 35px 50px;">
          <input type="submit" name="res" value="Results Phase"
            style="width: 24%;height: 100px; margin: 14px 0px; padding: 10px; font-size: x-large;">
        </div>
      </form>
  </section>
  <?php    
